...
R^\alpha(q)=
\begin{cases}
\mathcal M_{\mathrm{weak}},&P(\mathrm{win}_s\mid q)\lt \alpha,\\
...
![作者原图 main-gsm8k](../../../assets/papers/2406.18665/main-gsm8k.png)
![作者原图 main-mt-bench](../../../assets/papers/2406.18665/main-mt-bench.png)
![作者原图 main-mmlu](../../../assets/papers/2406.18665/main-mmlu.png)
...
![MT Bench上与Unify AI、Martian等路由系统比较](../../../assets/papers/2406.18665/independent-benchmark-part-1.png)

![MT Bench上与Unify AI、Martian等路由系统比较](../../../assets/papers/2406.18665/independent-benchmark-part-2.png)
...
* `main`：作者图 1，TeX label `fig:main`，由三个子图组成：`gsm8k.png`（左）、`mt-bench.png`（中）、`mmlu-main.png`（右）；caption 是 GPT-4/Mixtral call-performance、增强效果、CPT 和 APGR 说明。draft 标记分别用 ![作者原图 main-gsm8k](../../../assets/papers/2406.18665/main-gsm8k.png)、![作者原图 main-mt-bench](../../../assets/papers/2406.18665/main-mt-bench.png)、![作者原图 main-mmlu](../../../assets/papers/2406.18665/main-mmlu.png)。
* `independent-benchmark`：附录图，TeX label `fig:independent-benchmark`，`indep-benchmarks-llama.png` 和 `indep-benchmarks.png`；商业 Unify/Martian 对比，标记 ![MT Bench上与Unify AI、Martian等路由系统比较](../../../assets/papers/2406.18665/independent-benchmark-part-1.png)
