...
![Benchmark performance of DeepSeek-Prover-V2. On the AIME benchmark, DeepSeek-V3 is evaluated using the standard find-answer task for natural-language reasoning, while prover models generate Lean code to construct formal proofs for a given correct answer.](../../../assets/papers/2504.21801/figure-1-cover.png)
...
![Overview of the cold-start data collection process employed by DeepSeek-Prover-V2. DeepSeek-V3 produces a natural-language proof sketch and Lean statements with sorry placeholders; a 7B prover recursively solves subgoals; proofs are composed and appended to the chain of thought.](../../../assets/papers/2504.21801/figure-2-overview-decomposition.png)
...
![An illustrative example translating decomposed subgoals into lemma statements: (a) substitute the original goal; (b) incorporate preceding subgoals as premises. Type (b) supports recursive solving; both types enter curriculum learning.](../../../assets/papers/2504.21801/figure-3-conjecture-example.png)
