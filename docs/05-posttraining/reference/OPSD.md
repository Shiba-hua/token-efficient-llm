...
D\!\left(p_T(\cdot\mid x,y^\star,\hat y_{\lt n})\;\middle\|\;
p_S(\cdot\mid x,\hat y_{\lt n})\right).
```
...
```math
A_n=\log p_T(\hat y_n\mid x,y^\star,\hat y_{\lt n})-
\log p_S(\hat y_n\mid x,\hat y_{\lt n}),
```
...
![Token Efficiency of OPSD; Qwen3-1.7B comparison with GRPO](../../../assets/papers/2601.18734/fig-token-efficiency.png)
