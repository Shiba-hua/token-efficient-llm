...
![An Example to illustrate the overthinking phenomenon](../../../assets/papers/2503.04472/figure-1.png)
...
![Average token budget distribution across difficulty levels (Lmax = 4096)](../../../assets/papers/2503.04472/figure-3.png)

图 3 展示不同难度的平均 TLB，横向比较 QwQ-32B-preview 与 DS-32B，并标出 $`L_{max}=4096`$。它说明 TLB 是连续的经验长度参考；不能把图中的相关性直接解释为因果证明。

![Calibrated reward function with TLB](../../../assets/papers/2503.04472/figure-4.png)

图 4 是以 $`\lambda`$ 为横轴的校准奖励曲线：正确曲线在超预算后下降、在短于预算时上升并有下限；错误曲线在预算不足时更负、靠近预算时上升并有上限。它直接解释 DCP 与 DICP 为何方向相反。

![Comparative results for different difficulty levels on MATH-500; subfigures: Accuracy on different levels; Token length on different levels](../../../assets/papers/2503.04472/figure-5-part-1.png)

![Comparative results for different difficulty levels on MATH-500; subfigures: Accuracy on different levels; Token length on different levels](../../../assets/papers/2503.04472/figure-5-part-2.png)

图 5 把 DS-32B 在 MATH-500 五个等级的准确率和 token length 分开画出。DAST 的压缩在 Level 1 最大，Level 5 最小；SimPOShortest 的长度压缩更均匀，却在难题上牺牲能力。

![The impact of truncation threshold delta](../../../assets/papers/2503.04472/figure-6.png)
