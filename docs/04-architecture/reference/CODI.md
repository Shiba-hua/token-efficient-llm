...
```math
\mathcal{L}_{\text{KD}}
=\frac1M\sum_{l=1}^{M}\left|\mathrm{sg}[h^l_{\text{teacher}}]-h^l_{\text{student}}\right|.
```
...
![Results on five datasets (Top: GPT-2, Bottom: LLaMA3.2-1b-Instruct).](../../../assets/papers/2502.21074/fig-codi-result.png)
...
![Accuracy on GSM8k against the number of continuous thought tokens used during training.](../../../assets/papers/2502.21074/fig-codi-lat-num.png)
...
* ![Comparison of reasoning strategies: No-CoT-SFT, CoT-SFT, Coconut, CODI.](../../../assets/papers/2502.21074/fig-codi-illustrate.png)：Figure 1，三种推理策略比较（No-CoT-SFT、CoT-SFT、Coconut、CODI）；本版本源图为 `assets/codi_illustrate16.png`。
* ![CODI student and teacher tasks with cross-layer hidden-state L1 self-distillation.](../../../assets/papers/2502.21074/fig-codi-method.png)：Figure 2，student 连续路径、teacher forcing 路径和跨层 L1 蒸馏；源图 `assets/codi_method_v4.png`。
* ![Results on five datasets (Top: GPT-2, Bottom: LLaMA3.2-1b-Instruct).](../../../assets/papers/2502.21074/fig-codi-result.png)：Figure 3，GPT-2/LLaMA 在 GSM8k、GSM8k-NL、CommonsenseQA 的 accuracy；源图 `assets/codi_main_result_v5.png`。
* ![Efficiency comparison in inference time per math problem on GSM8k; batch size 1 on Nvidia A100; CoT token counts in parentheses.](../../../assets/papers/2502.21074/fig-efficiency.png)：Figure 4，A100 batch=1 的每题推理时间与 CoT token 数；源图 `assets/codi_efficiency_v2.png`。
* ![Accuracy on GSM8k against the number of continuous thought tokens used during training.](../../../assets/papers/2502.21074/fig-codi-lat-num.png)：Figure 5，连续 thought 数与 GSM8k accuracy；源图 `assets/codi_lat_num.png`。
* ![Interpretability case study: attended tokens and decoded tokens of six latent thought tokens.](../../../assets/papers/2502.21074/fig-codi-interpretability.png)：Figure 6，六个 latent thoughts 的 attended/decoded tokens；源图 `assets/codi_interpretability_3steps_v2.png`；附录还提供 1/2-step 版本。
