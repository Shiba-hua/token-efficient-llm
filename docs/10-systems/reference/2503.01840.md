...
![Temperature-0 speedup ratios for a subset of methods and targets.](../../../assets/papers/2503.01840/fig-speedup-part-1.png)

![Temperature-0 speedup ratios for a subset of methods and targets.](../../../assets/papers/2503.01840/fig-speedup-part-2.png)
...
```math
\mathrm{norm}\!\left(\max(0,p_{j+i}-\hat p_{j+i})\right)
```
...
![EAGLE-3 inference pipeline with fused low/middle/high features and three draft steps.](../../../assets/papers/2503.01840/fig-pipline-part-1.png)

![EAGLE-3 inference pipeline with fused low/middle/high features and three draft steps.](../../../assets/papers/2503.01840/fig-pipline-part-2.png)
...
![Attention causal masks for native and simulated training-time test steps.](../../../assets/papers/2503.01840/fig-mask-part-1.png)

![Attention causal masks for native and simulated training-time test steps.](../../../assets/papers/2503.01840/fig-mask-part-2.png)
...
![Scaling law on MT-bench/LLaMA-Instruct 3.1 8B: speedup ratio and average acceptance length versus data scale relative to ShareGPT.](../../../assets/papers/2503.01840/fig-sc-part-1.png)

![Scaling law on MT-bench/LLaMA-Instruct 3.1 8B: speedup ratio and average acceptance length versus data scale relative to ShareGPT.](../../../assets/papers/2503.01840/fig-sc-part-2.png)
...
![Acceptance-rate comparison across data scales; first and second draft positions.](../../../assets/papers/2503.01840/fig-sc1-part-1.png)

![Acceptance-rate comparison across data scales; first and second draft positions.](../../../assets/papers/2503.01840/fig-sc1-part-2.png)
