...
![Comparison of previous works and LightMem.](../../../assets/papers/2510.18866/figure1-motivation.png)
...
```math
B_1=\{k\mid M_{k,k-1}>M_{k-1,k-2},\ M_{k,k-1}>M_{k+1,k},\ 1\lt k\lt n\}.
```

相邻句子的 embedding 相似度低于阈值 $`τ`$ 时得到

```math
B_2=\{k\mid \mathrm{sim}(s_{k-1},s_k)\lt \tau,\ 1\le k\lt n\},\qquad B=B_1\cap B_2.
```
...
![Analysis and Ablation Study of Key Modules: compression-ratio accuracy, segmentation-method comparison, and topic-segmentation ablations.](../../../assets/papers/2510.18866/figure3-analysis.png)
...
![Impact of STM buffer threshold th on performance and efficiency across compression ratios r.](../../../assets/papers/2510.18866/figure4-threshold.png)
...
![Example of Topic Segment Attention Matrix.](../../../assets/papers/2510.18866/figure5-attention-part-1.png)

![Example of Topic Segment Attention Matrix.](../../../assets/papers/2510.18866/figure5-attention-part-2.png)

![Example of Topic Segment Attention Matrix.](../../../assets/papers/2510.18866/figure5-attention-part-3.png)
