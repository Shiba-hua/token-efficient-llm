...
![Figure 2: MMLU准确率、prompt token消耗和AgentPrune概览](../../../../assets/papers-v3/2410.02506/figure-2-intro.png)
...
-\sum_{X\in\{S,T\}}\operatorname{rank}(S^X),
...
```math
B=\mathbf 1\!\left(A\neq0\;\land\;
\operatorname{TopK}\big(S,|A|\times(1-p\%)\big)\right).
```
...
![Figure 6: agent prompt attack下各框架MMLU准确率](../../../../assets/papers-v3/2410.02506/figure-6-attack.png)
...
![Figure 21: agent数与early stopping/query轮数敏感性](../../../../assets/papers-v3/2410.02506/figure-21-sensitivity.png)
...
![Figure 24: complete graph + MMLU一次性空间剪枝](../../../../assets/papers-v3/2410.02506/figure-24-complete-mmlu-pruning.png)

![Figure 30: HumanEval中LLM-Debate式时间剪枝](../../../../assets/papers-v3/2410.02506/figure-30-temporal-humaneval.png)

![Figure 32: MMLU空间connectivity mask随轮次演化](../../../../assets/papers-v3/2410.02506/figure-32-connectivity-mmlu.png)
