...
![Fig.1 Long/medium/short CoT example and LoRA valve](../../../../assets/papers-v3/2502.09601/teaser.png)
...
![Fig.2 CoT-Valve stages and MixChain construction](../../../../assets/papers-v3/2502.09601/main.png)
...
![Fig.3a/正文曲线: GSM8K QwQ length and accuracy](../../../../assets/papers-v3/2502.09601/gsm8k_qwq.png)
...
![Fig.3b/正文曲线: GSM8K LLaMA-3.2-1B length and accuracy](../../../../assets/papers-v3/2502.09601/gsm8k_llama1b.png)
...
![Fig.3c: AIME Qwen2.5-32B-Instruct with LIMO, short-long-short and epoch dynamics](../../../../assets/papers-v3/2502.09601/limo_qwen.png)
...
- ![Fig.1 Long/medium/short CoT example and LoRA valve](../../../../assets/papers-v3/2502.09601/teaser.png)：Fig. 1，`assets/teaser_v9.pdf`；同一题目的长/中/短链示例，支持解释 LoRA 阀门的可变长度行为。
- ![Fig.2 CoT-Valve stages and MixChain construction](../../../../assets/papers-v3/2502.09601/main.png)：Fig. 2，`assets/main_v8.pdf`；Stage 1 得方向、Stage 2 生成 MixChain、Stage 3 用 CoT-Valve++/CoT-Valve+P 改良的流程图。
- ![作者原图 exp_main](../../../../assets/papers-v3/2502.09601/exp_main-part-1.png)

![作者原图 exp_main](../../../../assets/papers-v3/2502.09601/exp_main-part-2.png)：Fig. 3 总图；由下列三个独立资产组成，`assets/gsm8k_qwq.pdf`、`assets/gsm8k_llama1b.pdf`、`assets/limo_qwen.pdf`，分别为 GSM8K-QwQ、GSM8K-LLaMA-3.2-1B、AIME-Qwen/LIMO 的长度—准确率关系。
- ![作者原图 gsm8k_qwq_curve](../../../../assets/papers-v3/2502.09601/gsm8k_qwq_curve-part-1.png)

![作者原图 gsm8k_qwq_curve](../../../../assets/papers-v3/2502.09601/gsm8k_qwq_curve-part-2.png)：正文 Fig. 4（LaTeX label），`assets/gsm8k_qwq.pdf`；QwQ 在 GSM8K 的方法曲线。
- ![作者原图 gsm8k_llama1b_curve](../../../../assets/papers-v3/2502.09601/gsm8k_llama1b_curve-part-1.png)

![作者原图 gsm8k_llama1b_curve](../../../../assets/papers-v3/2502.09601/gsm8k_llama1b_curve-part-2.png)：正文 Fig. 5（LaTeX label），`assets/gsm8k_llama1b.pdf`；1B 模型的长度—准确率曲线。
- ![Fig.3c: AIME Qwen2.5-32B-Instruct with LIMO, short-long-short and epoch dynamics](../../../../assets/papers-v3/2502.09601/limo_qwen.png)：正文 Fig. 3(c) 子图，`assets/limo_qwen.pdf`；Qwen/LIMO 的 short-to-long、long-to-short 和训练 epoch 动态。
