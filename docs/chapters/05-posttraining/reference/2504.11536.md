...
\operatorname{clip}\left(\frac{\pi_\theta(o_t\mid q,o_{<t};\mathrm{CI})}
...
- ![AIME 2024/2025 scores of ReTool and text-based RL baseline](../../../../assets/papers-v3/2504.11536/fig-main-results.png)：Figure 1，AIME2024/2025 上 ReTool 与 text-based RL 的训练步数—准确率曲线；源文件 [`assets/code-rl.pdf`](../../../../assets/papers-v3/2504.11536/fig-main-results.pdf)。横轴是 steps，纵轴是 accuracy (%)，展示 32B Qwen backbone 的收敛差异。
- ![Text-based RL and ReTool interleaved code execution process](../../../../assets/papers-v3/2504.11536/fig-model-rl.png)：Figure 2，text-only rollout 与交错 CI rollout 对照；源文件 [`assets/method.pdf`](../../../../assets/papers-v3/2504.11536/fig-model-rl.pdf)。左侧只有 policy→reward/advantage，右侧显示 policy、sandbox、interpreter feedback 和 reward 的闭环。
- ![CI-related behavior evolution during RL training](../../../../assets/papers-v3/2504.11536/fig-cog.png)：Figure 3，六个 CI 行为指标随 RL steps 的变化；源文件 [`assets/training_process_bold.pdf`](../../../../assets/papers-v3/2504.11536/fig-cog.pdf)。需结合上文定义读取，不能把 code pass rate 当答案准确率。
- ![The case of aha moment about code self-correction](../../../../assets/papers-v3/2504.11536/fig-aha.png)：Figure 4，`greedy()` 未定义后自校正；源文件 [`assets/aha.pdf`](../../../../assets/papers-v3/2504.11536/fig-aha.pdf)。箭头顺序是错误反馈→模型反思→补定义→成功执行→答案。
- ![Code purpose analysis](../../../../assets/papers-v3/2504.11536/fig-purpose.png)：Figure 5，RL 前后代码用途词云；源文件 [`assets/pie_chart.png`](../../../../assets/papers-v3/2504.11536/fig-purpose.png)。分类器为 Doubao-1.5-pro，图中频数是重复出现用途的词云呈现。
- ![Case of CI-powered reasoning vs. text-based reasoning](../../../../assets/papers-v3/2504.11536/fig-case1.png)：Figure 6，同题 text-based 与 CI-powered reasoning 对照；源文件 [`assets/case1.pdf`](../../../../assets/papers-v3/2504.11536/fig-case1.pdf)。左侧手算导致 629，右侧程序枚举得到 699。
- ![Template prompt for ReTool rollout](../../../../assets/papers-v3/2504.11536/fig-rollout-prompt.png)：附录 Figure 7，rollout prompt 模板；源文件 [`assets/prompt.pdf`](../../../../assets/papers-v3/2504.11536/fig-rollout-prompt.pdf)。用于说明 `<code>`/`<interpreter>` 格式。
- ![Template prompt for data curation](../../../../assets/papers-v3/2504.11536/fig-data-prompt.png)：附录 Figure 8，数据构造提示模板；源文件 [`assets/prompt2.pdf`](../../../../assets/papers-v3/2504.11536/fig-data-prompt.pdf)。只为理解冷启动转换流程补读，正文没有相应实验结果。
