...
~~~math
\\mathbf a_{cls}=\\operatorname{softmax}\\left(
...
![Distribution of attention values](../../../../assets/papers-v3/2403.15388/fig-attn_cls_dirtibution.png)
...
~~~math
\\operatorname{Sim}(\\mathbf y_i,\\mathbf y_j)
...
![PruMerge has 3 steps](../../../../assets/papers-v3/2403.15388/fig-pipeline.png)
...
![Image & Tokens Visualizations](../../../../assets/papers-v3/2403.15388/figure-visualized_to_prumerge_plus.png)
