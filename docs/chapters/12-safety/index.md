...
![本章研究路线图](../../../assets/maps-v3/12-safety.png)
...
[查看原图，可放大](../../../assets/papers-v3/2502.02542/attack_method.pdf) · [论文来源](https://arxiv.org/abs/2502.02542v4)
...
![Threat model and monitor placement. The attacker injects a reasoning-consuming decoy through any text-bearing context channel. RecurGuard monitors exposed reasoning traces online and can halt generation; QDM operates post-hoc on the final output when traces are hidden.](../../../assets/papers-v3/2606.07968/fig1.png)

[查看原图，可放大](../../../assets/papers-v3/2606.07968/fig1.pdf) · [论文来源](https://arxiv.org/pdf/2606.07968)
