...
设题目为 $q$，正确答案为 $y^*(q)$，测试时策略超参数为 $\theta$，预算为 $N$。论文定义 $\operatorname{Target}(\theta,N,q)$ 为该策略诱导的输出 token 分布，并定义：
...
**图读法：** ![作者原图 fig2-prm-search](../../../../assets/papers-v3/2408.03314/fig2-prm-search-part-1.png)

![作者原图 fig2-prm-search](../../../../assets/papers-v3/2408.03314/fig2-prm-search-part-2.png) 图 2 用三个示意图对齐 best-of-N、beam、lookahead 的候选树和预算含义；![作者原图 fig3-search-sweep](../../../../assets/papers-v3/2408.03314/fig3-search-sweep-part-1.png)

![作者原图 fig3-search-sweep](../../../../assets/papers-v3/2408.03314/fig3-search-sweep-part-2.png) 图 3 左图是方法随生成预算的曲线，右图按难度 bin 和预算 4/16/64/256 对比 beam 与 best-of-N；![作者原图 fig4-compute-optimal-search](../../../../assets/papers-v3/2408.03314/fig4-compute-optimal-search-part-1.png)

![作者原图 fig4-compute-optimal-search](../../../../assets/papers-v3/2408.03314/fig4-compute-optimal-search-part-2.png) 图 4 对每个 difficulty bin 取最优 search 策略，oracle 与 predicted 曲线大体重合，在例如 16 generations 处接近或超过 best-of-N 的 64 generations，体现约 4× 预算效率提升。原图未在本目录取得，以上为基于正文图注和相邻段落的结构读图。
...
**图读法：** ![作者原图 fig5-revision-vs-parallel](../../../../assets/papers-v3/2408.03314/fig5-revision-vs-parallel-part-1.png)

![作者原图 fig5-revision-vs-parallel](../../../../assets/papers-v3/2408.03314/fig5-revision-vs-parallel-part-2.png) 图 5 解释并行候选和顺序修订，以及如何先链内、再链间选择；![作者原图 fig6-revision-pass1](../../../../assets/papers-v3/2408.03314/fig6-revision-pass1-part-1.png)

![作者原图 fig6-revision-pass1](../../../../assets/papers-v3/2408.03314/fig6-revision-pass1-part-2.png) 图 6 左为每个修订步的 pass@1 上升，右为顺序与并行选择比较；![作者原图 fig7-sequential-parallel-ratio](../../../../assets/papers-v3/2408.03314/fig7-sequential-parallel-ratio-part-1.png)

![作者原图 fig7-sequential-parallel-ratio](../../../../assets/papers-v3/2408.03314/fig7-sequential-parallel-ratio-part-2.png) 图 7 左固定总预算改变顺序/并行比例，右固定预算 128 按难度展示比例差异：容易题更偏顺序，困难题存在混合最优比例；![作者原图 fig8-compute-optimal-revision](../../../../assets/papers-v3/2408.03314/fig8-compute-optimal-revision-part-1.png)

![作者原图 fig8-compute-optimal-revision](../../../../assets/papers-v3/2408.03314/fig8-compute-optimal-revision-part-2.png) 图 8 按难度选择比例，compute-optimal 在例如 64 samples 处达到或超过并行基线 256 samples 的水平，约 4× 节省。附录 B 的 majority 版本总体趋势类似，但容易题对比例较不敏感、困难题有明显最优比例。
